              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    color: Colors.red.withOpacity(alpha: 0.2 * _animation.value),
                  ),
                ),
                ...
                Transform.translate(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: Colors.cyan.withOpacity(alpha: 0.2 * _animation.value),
                    ),
                  ),
                ),
                ...
                Transform.translate(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: Colors.green.withOpacity(alpha: 0.2 * _animation.value),
                    ),
                  ),
                ),
              ],
