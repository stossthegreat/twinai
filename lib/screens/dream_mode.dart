          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  AppColors.purple500.withOpacity(alpha: 0.15),
                  AppColors.indigo500.withOpacity(alpha: 0.15),
                  AppColors.pink500.withOpacity(alpha: 0.15),
                ],
              ),
              border: Border.all(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  AppColors.pink500.withOpacity(alpha: 0.2),
                ],
              ),
              border: Border.all(
                color: AppColors.indigo500.withOpacity(alpha: 0.5),
                width: 2,
              ),
              borderRadius: BorderRadius.circular(16),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppColors.purple400.withOpacity(alpha: 0.3),
          width: 2,
        ),
        borderRadius: BorderRadius.circular(16),
      ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: RadialGradient(
                            colors: [
                              AppColors.purple500.withOpacity(alpha: 0.4 * opacity),
                              AppColors.pink500.withOpacity(alpha: 0.4 * opacity),
                            ],
                          ),
                        ),
                      ),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: AppColors.purple200.withOpacity(alpha: 0.9),
                      letterSpacing: 3.0,
                    ),
                  ),
                  const SizedBox(height: 8),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...dream.symbols.map((symbol) => Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.purple500.withOpacity(alpha: 0.1),
                        border: Border.all(
                          color: AppColors.purple400.withOpacity(alpha: 0.3),
                          width: 1,
                        ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.pink500.withOpacity(alpha: 0.1),
                        border: Border.all(
                          color: AppColors.pink400.withOpacity(alpha: 0.3),
                          width: 1,
                        ),
                        borderRadius: BorderRadius.circular(6),
                      ),
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          color: AppColors.pink200.withOpacity(alpha: 0.9),
                        ),
                      ),
                    ),
                  ],
    ...
    switch (dream.type) {
      ...
      case "PROPHETIC":
        return LinearGradient(
          ...
          colors: [
            AppColors.purple500.withOpacity(alpha: 0.25),
            AppColors.pink500.withOpacity(alpha: 0.15),
          ],
        );
      case "SHADOW":
      ...
      case "LUCID":
        return LinearGradient(
          ...
          colors: [
            ...
            AppColors.blue500.withOpacity(alpha: 0.15),
          ],
        );
      default:
        return LinearGradient(
